...
CAMERASLACK = 90 # how far from the center the squirrel moves before the camera
...
Enemy Squirrel data structure keys:
    ...
    'movey' - how many pixels per frame the squirrel moves veritcally. A negative integer is moving up, a positive moving down.
...
Grass data structure keys:
    'grassImage' - an interger that refers to the index of the pygame.Surface object in GRASSIMAGES used for this grass object.
"""
...
def runGame():
    ...
    # create the surfaces to hold the game text
    ...
    squirrelObjs = [] # stores all the non-player squirrel obects
    # stores the player oject:
        ...
        if not gameOverMode:
            ...
            for i in range(len(squirrelObjs)-1,-1,-1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    # player/squirrel collision has occured
...
def getRandomOffCameraPos(camerax, cameray, objWidth, objHeight):
    ...
    while True:
        ...
        # create a Rect object with the random coordinates and use a colliderect()
